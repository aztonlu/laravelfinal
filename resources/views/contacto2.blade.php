    ...
    <div class="container">
        ...
        <div class="col-md-9 tab-wrap">
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active"><a href="#itenary">Forme de contact</a></li>
            </ul>
                    ...
                    <div class="row day-description-content">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                              {!! Form::text('name', null, ['placeholder' => 'Nom complet' ]) !!}
                             </div>
                             <br>

                             <div class="form-group">
                              {!! Form::text('telefono', null, ['placeholder' => 'Téléphone' ]) !!}
                             </div>
                             <br>

                             <div class="form-group">
                              {!! Form::text('pais', null, ['placeholder' => 'Pays' ]) !!}
                             </div>
                             <br>
                            ...
                            <br>
                            <div class="form-group">
                            {!! Form::textarea('mensaje', null, ['placeholder' => 'Poste' ]) !!}
                            </div>
                            <br>
                            <div class="form-group">
