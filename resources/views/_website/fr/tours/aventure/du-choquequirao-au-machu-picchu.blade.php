...
<div class="trip-detail">
    <div class="container">
        ...
        <div class="col-md-9 tab-wrap">
            <h2>Du Choquequirao au Machu Picchu</h2>
            ...
            <div class="description">
                ...
                <p>De la côte au MachuPicchu, ce voyage combine les étapes incontournables du Pérou. Ainsi, vous commencez par la côte avec les îles Ballestas puis l’oasis de Huacachina, sans oublier Nasca et ses mystérieuses lignes. Vous poursuivez en visitant la ville mythique d’Arequipa et le canyon de Colca avant de vous aventurer sur le lac Titicaca. Vous passez la nuit chez les habitants d’Amantani, ce qui vous donne l’occasion d’échanger sur leur culture et leurs traditions. Votre séjour se termine par l’incontournable région de Cusco et ses sites incas : parmi ceux-ci, vous découvrez la majestueuse citadelle du Machu Picchu encore tout enveloppée de mystère.</p>
                <h3>Les points forts du voyage  « Trésors du sud Pérou »</h3>
                <ul>
                    <li>La côte, le canyon de Colca, le lac Titicaca et la région de Cusco avec le Machu Picchu, en seulement 15 jours</li>
                    <li>Des transports privés pour voyager à votre rythme</li>
                    <li>Un circuit « découverte » accessible à tous</li>
                </ul>
            </div>
            ...
            <div class="tab-content paper-effect">
                ...
                <div class="tab-pane" id="overview">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4>ENCADREMENT</h4>
                            <p>Voyage accompagné par un guide péruvien local anglophone / hispanophone / francophone à chacune des étapes, tel que mentionné dans votre programme. Autrement dit, vous aurez un guide différent dans chaque région visitée, compte tenu de leurs spécificités.</p>
                            <p>Le niveau de français des guides diffère d´une région à l´autre.</p>
                            ...
                            <p>Quelques exceptions :</p>
                            <ul>
                                <li>Pour les longues distances telles que Nazca - Arequipa, vous serez en bus de ligne confortables et sécurisés.</li>
                                <li>Pour certaines excursions, vous voyagerez en transport collectif, comme au lac Titicaca.</li>
                                <li>Pour la route Puno-Cusco / Chivay – Puno, vous serez dans un bus touristique collectif effectuant plusieurs arrêts/visites en cours de route.</li>
                            </ul>
                        </div>
                    </div>
                </div>
