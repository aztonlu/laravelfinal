    ...
    <div class="top-header">
        <div class="wrap-top">
            <div class="info-top pull-left">
                ...
                <small class="top-element"><a href="#">Rufen Sie uns jetzt an: 00 51 84 247277</a></small>
            </div>
    ...
    <div class="container">
        ...
        <div class="col-md-9 tab-wrap">
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active"><a href="#itenary">Kontaktformular</a></li>
            </ul>
                    ...
                    <div class="row day-description-content">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                              {!! Form::text('name', null, ['placeholder' => 'Vollständiger Name' ]) !!}
                             </div>
                             <br>

                             <div class="form-group">
                              {!! Form::text('telefono', null, ['placeholder' => 'Telefon' ]) !!}
                             </div>
                             <br>

                             <div class="form-group">
                              {!! Form::text('pais', null, ['placeholder' => 'Land' ]) !!}
                             </div>
                             <br>
                            ...
                            <br>
                            <div class="form-group">
                            {!! Form::textarea('mensaje', null, ['placeholder' => 'Post' ]) !!}
                            </div>
                            <br>
                            <div class="form-group">
                            {!! Form::submit('Senden', ['class' => 'btn btn-success ' ] ) !!}
                            </div>
                            {!! Form::close() !!}
                            </div>
                        </div>
