      ...
      <div class="row" sty>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3">
                   <h4>Aventure</h4>
              <a href="{{url('')}}/en/tours/decouverte/Aventure"><img src="{{url('')}}/images/Aventura.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                  <h4>Decouverte</h4>
              <a href="{{url('')}}/en/tours/decouverte/Discover"><img src="{{url('')}}/images/Descubir.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                   <h4>Excursions</h4>
                <a href="{{url('')}}/en/tours/decouverte/Excursions"><img src="{{url('')}}/images/Excursiones.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
        </div>
    </div>
