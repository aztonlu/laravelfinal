<?php use App\Models\Article; $articles = Article::where("blog_id",53)->get();?> @extends("website.partials.es.maintrip") @section("fgh", "Mapa, Ruta") @section("keywords", "ruta, mapa") @section("description", "Blog de rutas")
