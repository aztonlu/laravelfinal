            ...
            <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <div class="main-title">
                        <h2>¿Quiénes somos?</h2>
                        <p align="justify">Tierras de los Andes es una S.A.C (Sociedad Anónima Cerrada) que abrió sus puertas en el año 2000. <br>
                        Tour operador peruano especializado en viajes de aventura, tenemos como objetivo principal la creación de estancias completas fuera del circuito turístico.  <br><br>

                        Estamos enfocando nuestros esfuerzos en una oferta turística de alta calidad y confiable que involucre a jugadores locales. Por lo tanto, estamos desarrollando un enfoque justo y responsable y damos gran importancia a la ecología y el respeto por el medio ambiente en el diseño de nuestras estancias.  <br>
                        Tierras de los Andes es una agencia que organiza estancias y ofrece una amplia selección de servicios y servicios para clientes individuales o grupales. <br>
                        Damos la bienvenida a familias y empresas de todo el mundo para descubrir Perú y más de América del Sur.  
                        <br><br>
                        Nuestro equipo está formado por profesionales del turismo, guías y trabajadores de campo que trabajan a tiempo completo con operadores locales repartidos por todo el Perú y Bolivia. <br>
                        Nuestra agencia ha desarrollado una fuerte asociación con los proveedores turísticos locales, ofreciendo así los mejores servicios en términos de transporte, guías y guías locales. <br><br>
                        Damos gran importancia a cada detalle de los viajes propuestos para que satisfagan plenamente la demanda de cada cliente y por lo tanto un éxito total.</p>
                    </div>
