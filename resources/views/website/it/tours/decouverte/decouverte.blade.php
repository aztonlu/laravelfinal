                        ...
                        <div id="collapse1One" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1One">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @elseif($tour->category == "Couple")
                                        <p align="center">Couple</p>
                                        @elseif($tour->category == "Group")
                                        <p align="center">Group</p>
                                        @elseif($tour->category == "Friends")
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" name="difficult">
                                            ...
                                            <option value="Medium">Mezzi</option>
                                    ...
                                    <button class="btn btn-search btn-primary hvr-sweep-to-right col-sm-12" type="submit">Per cercare</button>
    			...
    			<div class="item-list">
        				...
        				<div class="col-sm-7">
        					...
        					<div class="item-book">
                                    ...
                                    <a href="{{url('')}}/it/tourshow/{{ $tour->id }}" class="btn btn-primary hvr-sweep-to-right">Reserve</a>
...
<div class="container-fluid">
  <div class="row" style="text-align: center; color: white;">
      ...
      <div class="row" sty>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3">
                   <h4>Aventure</h4>
              <a href="{{url('')}}/it/tours/decouverte/Aventure"><img src="{{url('')}}/images/Aventura.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                  <h4>Haute Montagne</h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                  <h4>Decouverte</h4>
              <a href="{{url('')}}/it/tours/decouverte/Discover"><img src="{{url('')}}/images/Descubir.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                   <h4>Excursions</h4>
                <a href="{{url('')}}/it/tours/decouverte/Excursions"><img src="{{url('')}}/images/Excursiones.jpg" height="60%" width="60%" class="img-circle"></a>
            </div>
        </div>
    </div>
     <div class="col-xs-12 col-md-4">
            ...
            <h5 style="color: #fff;">Iscriviti per aggiornare nuove notizie e notifiche</h5>
