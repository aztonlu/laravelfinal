            ...
            <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <div class="main-title">
                        <h2>Chi siamo?</h2>
                        <p align="justify">Tierras de los Andes è un S.A.C (Sociedad Anónima Cerrada) che ha aperto le sue porte nel 2000. <br>
                        Operatore turistico peruviano specializzato in viaggi avventura, abbiamo come obiettivo principale la creazione di soggiorni completi al di fuori del circuito turistico.  <br><br>

                        Stiamo concentrando i nostri sforzi su un'offerta turistica di alta qualità e affidabile che coinvolge giocatori locali. Pertanto, stiamo sviluppando un approccio equo e responsabile e attribuiscono grande importanza all'ecologia e al rispetto dell'ambiente nella progettazione delle nostre stanze. <br>
                        Tierras de los Andes è un'agenzia che organizza soggiorni e offre un'ampia gamma di servizi e servizi per singoli o gruppi di clienti. <br>
                        Accogliamo con favore le famiglie e le imprese provenienti da tutto il mondo per scoprire il Perù e più da Sud America. 
                        <br><br>
                        Il nostro team è costituito da professionisti del settore turistico, guide e operatori del settore che lavorano a tempo pieno con operatori locali in tutto il Perù e la Bolivia.<br>
                        La nostra agenzia ha sviluppato una forte partnership con i fornitori del turismo locale, offrendo così i migliori servizi in termini di trasporto, guide e guide locali. <br><br>
                        Doniamo grande importanza a ogni dettaglio dei viaggi proposti in modo da soddisfare pienamente la domanda di ogni cliente e quindi un successo totale.</p>
                    </div>
