                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown megamenu">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="col-sm-6">
                                <h5 class="head"><i class="icon-backpack"></i><a href="{{url('')}}/en/tours/decouverte/Aventure"> Aventure</h5></a>
                    ...
                    <li class="dropdown submenu">
                        <a class="dropdown-toggle"s class="dropdown-toggle" href="{{url('')}}/#team">About us</a>
                        
                    </li>

                    <li><a href="{{url('')}}/#twitter">The blog</a></li>

                    <li><a href="{{url('')}}/#testimonial">Testimonials</a></li>

                    <li><a href="{{url('')}}/#map-section">Contact us</a></li>
                    <li class="dropdown">
