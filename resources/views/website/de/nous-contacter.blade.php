            ...
            <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <div class="main-title">
                        ...
                        <p>DÉCALAGE HORAIRE De mars à octobre (heure d’été), il faudra reculer votre montre de 7 heures en arrivant au Pérou, et de 6 heures seulement de novembre à février.   ÉLECTRICITÉ Voltage : 110/220V  Fréquence : 50/60 Hertz Les prises électriques au Pérou sont de deux types :  TÉLÉPHONE ET TÉLÉCOMMUNICATIONS Il est très facile de communiquer avec ses amis ou sa famille depuis le Pérou, les cabines téléphoniques étant nombreuses, et la couverture internet très bonne.Pour appeler du Pérou vers la France : 00 + 33 + numéro du correspondant (sans le 0 initial).  Pour appeler de la France vers le Pérou : 00 + 51 + indicatif de la ville (sans le 0) + numéro du correspondant.   Pour effectuer des appels intérieurs : indicatif de la région + numéro si l’on appelle dans une autre région. Sinon, ne pas composer l’indicatif.
 
COURRIER
 
Vous trouverez des boites postales dans chaque aéroport, et dans la grande majorité des hôtels. Nous recommandons cependant de préférer les postes centrales.   Il faut compter au moins 10 jours pour le destinataire reçoive une lettre depuis Lima.
 
ASSURANCE VOYAGE
 
Spécialiste de l'assurance voyage depuis plus de 35 ans, AVI International gère les assurances voyages de plus de 100 000 voyageurs dans le monde entier chaque année. AVI International propose les « Assurances Routard » conçues en partenariat avec le Guide du Routard : courte ou longue durée, avec ou sans franchise, des tarifs à la carte selon vos besoins.En savoir plus  > https://www.avi-international.com/?apporteur=XA6TR</p>
                    </div>
