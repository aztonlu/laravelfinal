            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red-gradient">
                        ...
                        <a href="{{route('reservations.index')}}" class="small-box-footer">Entrar al módulo <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red-gradient">
                        ...
                        <a href="{{route('transaccion.index')}}" class="small-box-footer">Entrar al módulo <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red-gradient">
                        ...
                        <a href="{{route('proceso.index')}}" class="small-box-footer">Entrar al módulo <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
