                ...
                <div class="col-lg-8 col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Editar "{{$newsletter->titulo}}"</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::open(['route' => ['newsletters.update', $newsletter],'method' => 'PUT', 'class'=>'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                       <div class="box-body">
                            <div class="form-group">
                                {!! Form::label('titulo', 'Titulo', ['class'=>'col-sm-2 control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::text('titulo', $newsletter->titulo, ['class' => 'form-control', 'placeholder' => 'titulo', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('description', $newsletter->description, ['class' => 'form-control', 'placeholder' => 'Descripción']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::date('date', $newsletter->date, ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <br>
                                    <div id="divImg">
                                    <img id='imgView' style='width:100px;height:100px' src='../../../{{$newsletter->image}}'><br><input id='photo' name='photo' value='{{$newsletter->image}}'><br><br>
                            ...
                            {{leer_archivos_y_directorios('newsletters')}}
    ...
    else
    {
        ...
        echo "<br />No es ruta valida";
                        ...
                        <div class="box-footer">
                            <a href="{{route('newsletters.index')}}" class="btn btn-default pull-left">Cancelar</a>
