    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('')}}/admin/categoriaa">Categorías</a></li>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="alert alert-warning alert-dismissible" role="alert">
                                ...
                                <strong>Aviso!</strong> elija un icono de la lista inferior y copie el alias correspondiente.
                            </div>
                            ...
                            <div class="form-group">
                                {!! Form::label('icon', 'Alias del icono', ['class'=>'col-sm-2 control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::text('icon', $category->icon, ['class' => 'form-control', 'placeholder' => 'fa-aquí-el-alias-de-icono']) !!}
                                </div>
                        ...
                        <div class="box-body chat" id="chat-box" style="height: 500px;">
                            <!-- Lista de iconos -->
                            ...
                            <div class="box-body" id="fa-icons" >
                                ...
                                <section id="web-application">
                                    <h4 class="page-header">Icono de aplicaciones web</h4>
                                ...
                                <section id="hand">
                                    <h4 class="page-header">Iconos de señas</h4>
                                ...
                                <section id="transportation">
                                    <h4 class="page-header">Transportes</h4>
                                ...
                                <section id="chart">
                                    <h4 class="page-header">Estadisticas</h4>
                                ...
                                <section id="currency">
                                    <h4 class="page-header">Monedas</h4>
                                ...
                                <section id="medical">
                                    <h4 class="page-header">Medicina</h4>
