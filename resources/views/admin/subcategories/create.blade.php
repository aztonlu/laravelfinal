            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-xs-12">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        {!! Form::open(['route' => 'subcategories.store','method' => 'POST', 'class'=>'form-horizontal']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                {!! Form::label('category_id', 'Categoría', ['class'=>'col-sm-2 control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::select('category_id', $category, null, ['class' => 'form-control', 'placeholder' => 'Seleccione categoría', 'required']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('name', 'Sub-categoría', ['class'=>'col-sm-2 control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Nombre de la sub-categoría', 'required']) !!}
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
