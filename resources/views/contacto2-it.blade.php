    ...
    <div class="container">
        ...
        <div class="col-md-9 tab-wrap">
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active"><a href="#itenary">Modulo di contatto</a></li>
            </ul>
                    ...
                    <div class="row day-description-content">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              {!! Form::text('pais', null, ['placeholder' => 'Paese' ]) !!}
                             </div>
                             <br>
                            ...
                            <br>
                            <div class="form-group">
                            {!! Form::textarea('mensaje', null, ['placeholder' => 'Posta' ]) !!}
                            </div>
                            <br>
                            <div class="form-group">
                            {!! Form::submit('Mandare', ['class' => 'btn btn-success ' ] ) !!}
                            </div>
                            {!! Form::close() !!}
                            </div>
                        </div>
